...
class StaffViewSet(ViewSet):
    ...
    def partial_update(self, request, pk=None):
        ...
        try:
            ...
            profile_fields = ['years_of_experience', 'offline_consultation_price', 'online_consultation_price', 'preferred_consultation_duration', 'online_work_schedule', 'offline_work_schedule', 'clinic_id']
    ...
    def create(self, request):
        ...
        try:
            ...
            return Response({
                ...
                'birth_date': str(new_patient.birth_date) if new_patient.birth_date else None,
